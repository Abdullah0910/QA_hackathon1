...
# parallize_test_accross_combinations
    ...
    selenium_endpoint = "https://abdullah.goodsamaritan:LT_C47INsDKvWIWau0GxpVlsRShaHOq2KzyCESsyu9UEUspcNA@hub.lambdatest.com/wd/hub".format(username, access_key)
    ...
    setattr(item, "rep_" + rep.when, rep)
{
  "single_test": {
	...
	"browserVersion": "135",
	"LT:Options": {
		"username": "abdullah.goodsamaritan",
		"accessKey": "LT_C47INsDKvWIWau0GxpVlsRShaHOq2KzyCESsyu9UEUspcNA",
		"visual": True,
		"video": True,
